...
class SettingActivity : CommonActivity() {
    ...
    private fun bindEvent() {
        ...
        pref1.setOnClickListener {
            ...
            EasyPasswordHelper.startSettingActivityWithTransition(this@SettingActivity, intent)
        }

        pref2.setOnClickListener {
            EasyPasswordHelper.startSettingActivityWithTransition(this@SettingActivity, GoogleDriveUploader::class.java)
        }

        pref3.setOnClickListener {
            EasyPasswordHelper.startSettingActivityWithTransition(this@SettingActivity, GoogleDriveDownloader::class.java)
        }
        ...
        pref8.setOnClickListener {
            ...
            try {
                EasyPasswordHelper.startSettingActivityWithTransition(this@SettingActivity, goToMarket)
                ...
                EasyPasswordHelper.startSettingActivityWithTransition(this@SettingActivity, browser)
            }
        }

        pref9.setOnClickListener {
            EasyPasswordHelper.startSettingActivityWithTransition(this@SettingActivity, WebViewActivity.getStartIntent(this@SettingActivity, getString(R.string.setting_license_url)))
        }
    }
